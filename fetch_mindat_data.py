...
def fetch_geomaterial_batches(
	...
	# The batches live in "ima_geomaterial_batches" because they contain only
	# IMA-approved mineral IDs fetched by IMA number. Historical variants of
	# this project fetched by raw CSV ID and stored synonyms/non-IMA records;
	# the IMA-specific directory keeps the two unambiguously apart.
